...
!!! Definition "[Definice ($\varepsilon$-přechod)](#def-epsilon-prechod)"
...
!!! Definition "[Definice ($\varepsilon$-closure)](#def-epsilon-closure)"
...
!!! Algorithm "[Odstranění $\varepsilon$-přechodů](#algo-remove-epsilon)"
