...
!!! Algorithm "[Sjednocení](#op-sjednoceni)"
...
!!! Algorithm "[Konstrukce pomocí paralelní činnosti](#algo-paralelni-cinnost)"
    ...
    ![Paralelní činnost](../../assets/02/paralelni_cinnost_priklad_white.png#only-dark)
    ![Paralelní činnost](../../assets/02/paralelni_cinnost_priklad_black.png#only-light)

<a id="op-doplnek"></a>
!!! Algorithm "[Doplněk jazyka](#op-doplnek)"
...
<a id="op-soucin"></a>
!!! Algorithm "[Součin (zřetězení)](#op-soucin)"
...
!!! Algorithm "[Rozhodnutí, zdali L(M) = Σ*](#algo-decision-full)"
...
!!! Algorithm "[Rozhodnutí, zdali L(M) = ∅](#algo-decision-empty)"
...
!!! Algorithm "[Rozhodnutí, zdali L(M1) = L(M2)](#algo-decision-eq)"
...
!!! Algorithm "[Rozhodnutí, zdali L(M1) ⊆ L(M2)](#algo-decision-subset)"
