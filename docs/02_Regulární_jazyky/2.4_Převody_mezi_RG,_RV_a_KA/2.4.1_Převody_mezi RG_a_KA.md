...
!!! Algorithm "Regulární gramatika → Konečný automat"
    ...
    5. Pro pravidla tvaru $A \to aB$ přidáme přechod ze stavu $A$ na symbol $a$ do stavu $B$.
        ...
        ![RG → KA](../../assets/02/rg_to_ka1_white.png#only-dark){ align=center width="50%" }
        ![RG → KA](../../assets/02/rg_to_ka1_black.png#only-light){ align=center width="50%" }

    6. Pro pravidla tvaru $A \to a$ přidáme přechod ze stavu $A$ na symbol $a$ do koncového stavu $K$.

        ![RG → KA](../../assets/02/rg_to_ka2_white.png#only-dark){ align=center width="50%" }
        ![RG → KA](../../assets/02/rg_to_ka2_black.png#only-light){ align=center width="50%" }
...
!!! Algorithm "Konečný automat → Regulární gramatika"
    ...
    3. Pro přechody typu $B \in \delta(A, a)$ (kde $B$ je nekoncový stav) přidáme do gramatiky pravidlo $A \to aB$.
        ...
        ![KA → RG](../../assets/02/ka_to_rg1_white.png#only-dark){ align=center width="50%" }
        ![KA → RG](../../assets/02/ka_to_rg1_black.png#only-light){ align=center width="50%" }

    4. Pro přechody typu $B \in \delta(A, a)$ (kde $B$ je koncový stav) přidáme do gramatiky pravidla $A \to aB \mid a$.

        ![KA → RG](../../assets/02/ka_to_rg2_white.png#only-dark){ align=center width="50%" }
        ![KA → RG](../../assets/02/ka_to_rg2_black.png#only-light){ align=center width="50%" }
