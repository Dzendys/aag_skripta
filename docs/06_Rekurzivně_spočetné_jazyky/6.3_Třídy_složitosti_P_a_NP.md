...
!!! Definition "[Definice (Typy problémů)](#def-typy-problemu)"
...
!!! Definition "[Definice (Rozhodnutelnost)](#def-rozhodnutelnost)"
...
<a id="def-trida-p"></a>
!!! Definition "[Definice (Třída P)](#def-trida-p)"
...
<a id="def-trida-np"></a>
!!! Definition "[Definice (Třída NP)](#def-trida-np)"
...
!!! Definition "[Definice (NP-těžký a NP-úplný problém)](#def-np-tezky-uplny)"
    ...
    *   **NP-těžký (NP-hard) problém:** Problém, na který lze v polynomiálním čase **převést** (redukovat) všechny ostatní problémy ze třídy NP. Sám však v NP být nemusí.
        ...
        ![NP hard](../assets/06/np_hard_white.png#only-dark){ width="60%" }
        ![NP hard](../assets/06/np_hard_black.png#only-light){ width="60%" }

    *   **NP-úplný (NP-complete) problém:** Problém, který je **NP-těžký** a zároveň sám **patří do třídy NP**. Jsou to „nejtěžší“ problémy v NP.

        ![NP complete](../assets/06/np_complete_white.png#only-dark){ width="60%" }
        ![NP complete](../assets/06/np_complete_black.png#only-light){ width="60%" }

    *Příklady:* Problém obchodního cestujícího, SAT.

<a id="def-polynomialni-redukce"></a>
!!! Definition "[Definice (Polynomiální redukce)](#def-polynomialni-redukce)"
    ...
    ![Polynomiální redukce](../assets/06/redukce_white.png#only-dark){ width="75%" }
    ![Polynomiální redukce](../assets/06/redukce_black.png#only-light){ width="75%" }
