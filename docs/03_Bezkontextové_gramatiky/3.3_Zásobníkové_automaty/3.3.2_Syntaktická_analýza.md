...
!!! Algorithm "Konstrukce analyzátoru metodou shora dolů"
    ...
    *   **Operace:**
    ...
    ![Metoda shora dolů](../../assets/03/shora_dolu_white.png#only-dark){ align=center }
    ![Metoda shora dolů](../../assets/03/shora_dolu_black.png#only-light){ align=center }
...
!!! Algorithm "Konstrukce analyzátoru metodou zdola nahoru"
    ...
    *   **Operace:**
    ...
    ![Metoda zdola nahoru](../../assets/03/zdola_nahoru_white.png#only-dark){ align=center }
    ![Metoda zdola nahoru](../../assets/03/zdola_nahoru_black.png#only-light){ align=center }