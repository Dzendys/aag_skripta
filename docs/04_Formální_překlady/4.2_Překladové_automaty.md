...
*   **Ohodnocený orientovaný graf (stavový diagram):**
    ...
    ![Stavový diagram](../assets/04/stavovy_diagram1_white.png#only-dark){ align="center" width="50%" }
    ![Stavový diagram](../assets/04/stavovy_diagram1_black.png#only-light){ align="center" width="50%" }
...
*   **Stavový diagram:**
    ...
    ![Stavový diagram](../assets/04/stavovy_diagram2_white.png#only-dark){ align=center width="75%"}
    ![Stavový diagram](../assets/04/stavovy_diagram2_black.png#only-light){ align=center width="75%"}
