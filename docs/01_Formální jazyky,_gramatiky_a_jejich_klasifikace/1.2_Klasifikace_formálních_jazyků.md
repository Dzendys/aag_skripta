...
!!! Implication "Hierarchie jazyků"
    ...
    * **Kontextový jazyk** je vždy zároveň rekurzivně spočetný.
    ...
    ![Hiearchie jazyků](../assets/01/hiearchie_white.png#only-dark){ align=center width="75%" }
    ![Hiearchie jazyků](../assets/01/hiearchie_black.png#only-light){ align=center width="75%" }
...
!!! Warning "Uzavřenost jazyků pro vybrané operace"
    ...
    ![Uzavřenost tabulka](../assets/01/uzavrenost_tabulka_white.png#only-dark){ align=center width="50%" }
    ![Uzavřenost tabulka](../assets/01/uzavrenost_tabulka_black.png#only-light){ align=center width="50%" }
...
!!! Implication "Co to pro nás znamená, když je třída jazyků uzavřená pro nějakou operaci?"
    ...
    * **Bezkontextové jazyky** jsou uzavřené pro operaci sjednocení. Pokud tedy sjednotíme dva bezkontextové jazyky, výsledkem bude opět jazyk bezkontextový.
    ...
    ![Uzavřenost1](../assets/01/uzavrenost1_white.png#only-dark){ align=center width="75%" }
    ![Uzavřenost1](../assets/01/uzavrenost1_black.png#only-light){ align=center width="75%" }
    ...
    * **Bezkontextové jazyky** nejsou uzavřeny pro operaci průnik. Pokud tedy provedeme průnik dvou bezkontextových jazyků, výsledkem pouze může (ale nemusí) být jazyk bezkontextový.
    ...
    ![Uzavřenost2](../assets/01/uzavrenost2_white.png#only-dark){ align=center width="75%" }
    ![Uzavřenost2](../assets/01/uzavrenost2_black.png#only-light){ align=center width="75%" }