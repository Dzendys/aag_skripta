...
!!! Definition "[Gramatika](#def-gramatika)"
...
<a id="def-rg"></a>
!!! Definition "[Regulární gramatika (RG, typ 3)](#def-rg)"
...
<a id="def-bg"></a>
!!! Definition "[Bezkontextová gramatika (BG, typ 2)](#def-bg)"
...
<a id="def-kg"></a>
!!! Definition "[Kontextová gramatika (KG, typ 1)](#def-kg)"
...
<a id="def-ng"></a>
!!! Definition "[Neomezená gramatika (NG, typ 0)](#def-ng)"
...
!!! Algorithm "[Postup při návrhu gramatiky pro zadaný jazyk](#algo-navrh-gramatiky)"
...
!!! Algorithm "[Postup při klasifikaci „neznámého“ jazyka L](#algo-klasifikace-jazyka)"
