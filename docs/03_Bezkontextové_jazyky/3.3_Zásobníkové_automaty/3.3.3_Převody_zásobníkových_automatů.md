...
!!! Algorithm "[Algoritmus 9.10 (Převod ZA: Koncový stav $\to$ Prázdný zásobník)](#algo-za-final-to-empty)"
...
!!! Algorithm "[Algoritmus 9.11 (Převod ZA: Prázdný zásobník $\to$ Koncový stav)](#algo-za-empty-to-final)"
